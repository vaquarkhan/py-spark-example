...
# review link link
link = 'https://play.google.com/store/apps/details?id=kr.neogames.realfarm&hl=ko&showAllReviews=true'
...
for i in range(scroll_cnt):
  ...
  try:
    load_more = driver.find_element_by_xpath('//*[contains(@class,"U26fgb O0WRkf oG5Srb C0oVfc n9lfJ")]').send_keys(Keys.ENTER)
  except:
    load_more = driver.find_element_by_xpath('//*[contains(@class,"U26fgb O0WRkf oG5Srb C0oVfc n9lfJ M9Bg4d")]').send_keys(Keys.ENTER)
