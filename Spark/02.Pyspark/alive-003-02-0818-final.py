...
S3_location = 's3://aiml-dev-alive-003-etl/aiml-dev-alive-003-etl-result/'
...
read_catalog = glueContext.create_dynamic_frame.from_catalog(database = 'kd_etl', table_name = 'aiml_dev_alive_003_partition', transformation_ctx = "read_catalog")
