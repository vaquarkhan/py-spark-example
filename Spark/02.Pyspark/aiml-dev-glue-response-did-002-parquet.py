...
raw_data = glueContext.create_dynamic_frame.from_catalog(database = "kd_raw", table_name = "aiml_dev_response_did_002", transformation_ctx = "raw_data" ,push_down_predicate = push_down_condition)
S3_location = 's3://aiml-dev-response-did-002-partition/'
