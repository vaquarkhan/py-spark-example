...
def version(temp):
  ...
  l_values = {
    'roomcontrollerswversion': copy.deepcopy(temp['roomcontrollerswversion'].iloc[-1]),
    'boilercontrollerswversion': copy.deepcopy(temp['boilercontrollerswversion'].iloc[-1]),
    'boilercontrollerswsubversion': copy.deepcopy(temp['boilercontrollerswsubversion'].iloc[-1])
             }
...
alive002_standard_deviation = spark.read.format('csv').option('header','True').load('s3://aiml-dev-weather/macaddress_002_list_20210823082204.csv')
alive003_standard_deviation = spark.read.format('csv').option('header','True').load('s3://aiml-dev-weather/macaddress_003_list_20210823082204.csv')
...
# join_temp_002 = status002_df.join(alive002_df,(status002_df["macaddress"] == alive002_df["macaddress"])&(status002_df["start"] == alive002_df["start"]),'left').drop(alive002_df["macaddress"]).drop(alive002_df['additionalvalue']).drop(alive002_df['start']).drop(alive002_df['year']).drop(alive002_df['end']).drop(alive002_df['day']).drop(alive002_df['month']) \
#             .join(ehrd002_df,(status002_df["macaddress"] == ehrd002_df["macaddress"])&(status002_df["start"] == ehrd002_df["start"]),'left').drop(ehrd002_df["macaddress"]).drop(ehrd002_df['start']).drop(ehrd002_df['additionalvalue']).drop(ehrd002_df['year']).drop(ehrd002_df['end']).drop(ehrd002_df['day']).drop(ehrd002_df['month']) \
#             .join(did002_df,(status002_df["macaddress"]   == did002_df["macaddress"])&(status002_df["start"] == did002_df["start"]),'left').drop(did002_df["macaddress"]).drop(did002_df['start']).drop(did002_df['additionalvalue']).drop(did002_df['year']).drop(did002_df['end']).drop(did002_df['day']).drop(did002_df['month'])
...
# join_temp_003 = status003_df.join(alive003_df,(status003_df["macaddress"] == alive003_df["macaddress"])&(status003_df["start"] == alive003_df["start"]),'left').drop(alive003_df["macaddress"]).drop(alive003_df['additionalvalue']).drop(alive003_df['start']).drop(alive003_df['year']).drop(alive003_df['end']).drop(alive003_df['day']).drop(alive003_df['month']) \
#             .join(ehrd003_df,(status003_df["macaddress"] == ehrd003_df["macaddress"])&(status003_df["start"] == ehrd003_df["start"]),'left').drop(ehrd003_df["macaddress"]).drop(ehrd003_df['start']).drop(ehrd003_df['additionalvalue']).drop(ehrd003_df['year']).drop(ehrd003_df['end']).drop(ehrd003_df['day']).drop(ehrd003_df['month']) \
#             .join(did003_df,(status003_df["macaddress"]   == did003_df["macaddress"])&(status003_df["start"] == did003_df["start"]),'left').drop(did003_df["macaddress"]).drop(did003_df['start']).drop(did003_df['additionalvalue']).drop(did003_df['year']).drop(did003_df['end']).drop(did003_df['day']).drop(did003_df['month'])            
...
pdf = join_anlDF
# resultDF = pdf.selectExpr('*','cast(year as int) year','cast(month as int) month','cast(day as int) day','cast(temperature as double) temperature')
